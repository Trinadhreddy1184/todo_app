                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Align(
                                              ...
                                              child:Container(
                                                  width: 150,
                                                  child:(edit && changeindex==index)?
                                                  TextField(
                                                    decoration: InputDecoration(
                                                      hintText: TaskData.tasks.keys.elementAt(index),
                                                      hintStyle:  TextStyle(fontSize:20,fontWeight: FontWeight.w400,color: Colors.black ),
                                                    ),
                                                    onChanged: (value){
                                                      rename = value;
                                                    ...
                                                    cursorColor: Colors.black,
                                                    style: TextStyle(fontSize:20,fontWeight: FontWeight.w400,color: Colors.black ),
                                                  ):Text(TaskData.tasks.keys.elementAt(index),textAlign: TextAlign.left,style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20,color: Colors.black,decoration:(TaskData.tasks.values.elementAt(index))?TextDecoration.lineThrough:null),)
                                              ),),
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  Row(
                                                    ...
                                                    children: [IconButton(onPressed: (){
                                                      if(edit){
                                                        TaskData.renamekey(index, rename);
                                                        setState(() {
                                                          edit=!edit;
                                                          changeindex=null;
                                                        });
                                                    ...
                                                    }, icon:Icon((edit && changeindex==index)?Icons.save:Icons.edit_outlined,size: 30,color: Colors.black,)),
                                                      IconButton(onPressed:(){
